...
def train(args, teacher, student, generator, device, optimizer, epoch, loss_r_feature_layers):
...
def main():
    ...
    for epoch in range(1, number_epochs + 1):
        ...
        train(args, teacher=teacher, student=student, generator=generator, device=device, optimizer=[optimizer_S, optimizer_G], epoch=epoch, loss_r_feature_layers=loss_r_feature_layers)
        # Test
